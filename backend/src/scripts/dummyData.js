...
const insertDummyData = async () => {
  try {
    ...
    await File.insertMany([
      { file_id: 1, file_name: "image1.jpg", semina_id: 1 },
      { file_id: 2, file_name: "file1.pdf", semina_id: 1 },
      { file_id: 3, file_name: "image2.png", semina_id: 2 },
      { file_id: 4, file_name: "file2.pdf", semina_id: 2 },
      { file_id: 5, file_name: "image3.jpg", semina_id: 3 },
      { file_id: 6, file_name: "file3.pdf", semina_id: 3 },
      { file_id: 7, file_name: "image4.png", semina_id: 4 },
      { file_id: 8, file_name: "file4.pdf", semina_id: 4 },
      { file_id: 9, file_name: "image5.jpg", semina_id: 5 },
      { file_id: 10, file_name: "file5.pdf", semina_id: 5 },
      { file_id: 11, file_name: "image6.png", semina_id: 6 },
      { file_id: 12, file_name: "file6.pdf", semina_id: 6 },
      { file_id: 13, file_name: "image7.jpg", semina_id: 7 },
      { file_id: 14, file_name: "file7.pdf", semina_id: 7 },
    ]);
